...
export const metadata = {
    title: "Element Page Features || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
                                            ...
                                            <div className='services-3-item round text-center'>
                                                <div className='wow fadeInUpShort' data-wow-offset={50}>
                                                    ...
                                                    <div className='services-3-text'>
                                                        A brand is a name, term, design, lorem ipsum symbol or any other feature that identifies one
                                            ...
                                            <div className='services-3-item round text-center'>
                                                <div className='wow fadeInUpShort' data-wow-offset={50}>
                                                    ...
                                                    <div className='services-3-text'>
                                                        ...
                                                        term inclusive of service, and physical product design.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className='services-3-item round text-center'>
                                                <div className='wow fadeInUpShort' data-wow-offset={50}>
                                                    ...
                                                    <div className='services-3-text'>
                                                        ...
                                                        to be photographed and exhibited on film or other media.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className='row masonry mb-n30 wow fadeInUp'>
                                                    ...
                                                    <div className='col-md-6 mb-30'>
                                                        <div className='alt-features-item box-shadow text-center mt-0'>
                                                            ...
                                                            <div className='alt-features-descr'>
                                                                Vivamus varius, nisi vel dictum tempor, libero nisl iaculis est, ut rutrum elit ante
                                                                ac velit.
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className='row mt-n30'>
                                        ...
                                        >
                                            <div className='features-2-item pt-sm-40 pb-sm-40'>
                                                ...
                                                <div className='features-2-descr'>
                                                    Integer commodo mi ut velit bibendum eleifend. Duis nulla lectus, pharetra eu rhoncus id, pharetra
                                                    ut turpis.
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        >
                                            <div className='features-2-item pt-sm-40 pb-sm-40'>
                                                ...
                                                <div className='features-2-descr'>
                                                    Doneck maximus, dolor a condimentum congue, tellus nisi dictum magna, ut viverra massa ex sit amet
                                                    nulla.
                                                </div>
                                            </div>
                                        </div>
