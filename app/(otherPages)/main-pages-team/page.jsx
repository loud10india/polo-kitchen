                    ...
                    <main id='main'>
                        <section className='page-section pt-0 pb-0' id='home'>
                            <ParallaxContainer
                                ...
                                style={{
                                    backgroundImage: "url(/assets/images/full-width-images/page-title-bg-2.jpg)",
                                }}
                            >
                                <>
                            ...
                            <section className='page-section pt-0' id='team'>
                                <div className='container'>
                                    <div className='row position-relative mt-n40 mb-80 mb-sm-40 wow fadeInUp' data-wow-delay='0.2s'>
                                        ...
                                        >
                                            <Image src='/assets/images/decoration-1.svg' alt='' width={159} height={74} />
                                        </div>
                                            ...
                                            <div key={i} className='col-sm-6 col-lg-3 mt-40'>
                                                <div className='team-item'>
                                                    <div className='team-item-image'>
                                                        <Image src={elm.image} width={600} height={800} alt='Image Description' />
                                                        <div className='team-item-detail'>
                                                            <div className='team-social-links'>
                                                                {elm.socials.map((elm, i) => (
                                                                    <a key={i} href={elm.url} target='_blank' rel='noopener nofollow'>
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className='col-lg-8 wow linesAnimIn' data-wow-offset={0} data-splitting='lines'>
                                            <p className='mb-0'>
                                                ...
                                                Maecenas volutpat, diam eni sagittis quam porta quam. Sed id dolor consectetur fermentum volutpat
                                                accumsan purus. Etiam sit amet fringilla lacus susantebe sit ullamcorper pulvinar neque porttitor.
                                                Integere lectus. Praesent sede nisi eleifend fermum orci amet, iaculis libero. Donec vel ultricies
                                ...
                                <div className='container'>
                                    <div className='row'>
                                        <div className='col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center'>
                                            <h2 className='section-caption mb-xs-10 wow fadeInUp'>Clients Stories</h2>
                                    ...
                                    <div className='row position-relative'>
                                        <div className='col-md-6 col-lg-5 mb-md-50 mb-sm-30'>
                                            ...
                                            <p className='text-gray mb-0'>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pulvinar vitae neque et porttitor.
                                                Integer non dapibus diam, ac eleifend lectus. In maximus ligula semper metus pellentesque mattis.
                            ...
                            <section className='page-section'>
                                <div className='container position-relative'>
                                    ...
                                    <div className='position-relative'>
                                        ...
                                        >
                                            <Image src='/assets/images/decoration-3.svg' className='svg-shape' width={148} height={148} alt='' />
                                        </div>
                                    </div>
                                    {/* End Decorative Waves */}
                                    <div className='row wow fadeInUp'>
                                        ...
                                        <div className='col-md-4 col-lg-3 text-md-end'>
                                            <div className='local-scroll'>
                                                <Link href={`/main-pages-contact-1`} className='btn btn-mod btn-large btn-round btn-hover-anim'>
