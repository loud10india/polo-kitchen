        ...
        <div className='main-nav-sub full-wrapper'>
            ...
            <div className='nav-logo-wrap local-scroll'>
                <Link href={`/`} className='logo'>
                    <Image src='/assets/images/Polo-Kitchens.svg' alt='Your Company Logo' width={150} height={60} className='light-mode-logo' />
                    <Image src='/assets/images/polo-kitchens.svg' alt='Your Company Logo' width={150} height={60} className='dark-mode-logo' />
                </Link>
            </div>
            {/* Mobile Menu Button */}
