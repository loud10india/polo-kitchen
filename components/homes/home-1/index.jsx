    ...
    return (
        <>
                ...
                <div className='container position-relative'>
                    <div className='row mb-60 mb-xs-30'>
                        ...
                        <div className='col-md-5 offset-md-1 relative text-start text-md-end pt-40 pt-sm-20 local-scroll'>
                            ...
                            {onePage ? (
                                <a href='#team' className='link-hover-anim underline align-middle' data-link-animate='y'>
                ...
                <div className='container position-relative'>
                    <div className='row'>
                        <div className='col-lg-4 mb-md-60 mb-xs-50'>
                            <h2 className='section-title mb-20 wow fadeInUp'>Check recent achievements.</h2>
            ...
            <section className={`page-section  ${dark ? "bg-dark-1 light-content z-index-1" : ""}`}>
                <div className='container position-relative'>
                    {/* Decorative Waves */}
                    <div className='decoration-3 d-none d-sm-block' data-rellax-y='' data-rellax-speed='-0.7' data-rellax-percentage='0.5'>
                        <Image width={148} height={148} className='svg-shape' src='/assets/images/decoration-3.svg' alt='' />
                    </div>
                ...
                <div className='container position-relative'>
                    <div className='row mb-60 mb-xs-30'>
                        ...
                        <div className='col-md-5 offset-md-1 text-start text-md-end pt-40 pt-sm-20'>
                            <Link href={`/main-blog-columns-2col`} className='link-hover-anim underline align-middle' data-link-animate='y'>
