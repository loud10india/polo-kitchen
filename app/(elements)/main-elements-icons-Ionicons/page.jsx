...
export const metadata = {
    title: "Element Page Icons Lonicons || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
                            ...
                            <div className='container relative'>
                                <div className='row'>
                                    <div className='col-md-8 offset-md-2 mb-30'>
                                        <div className='text-center'>
                                            <p>
                                                You can use a set of 180+ Ionicons icon pack. Open this file in HTML code editor and copy SVG code of
                                                the icon below. Use the icon number to find choosen icon in the HTML code.
                                            </p>
                                        </div>
                                    </div>
                                </div>
