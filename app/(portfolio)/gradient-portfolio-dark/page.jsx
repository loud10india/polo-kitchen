...
export const metadata = {
    title: "Gradient Portfolio Dark || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
                ...
                <div className='dark-mode'>
                    <div className='page bg-dark-1' id='top'>
                        ...
                        <main id='main'>
                            ...
                            <section
                                className={`page-section scrollSpysection  overflow-hidden  ${dark ? "bg-dark-1 light-content" : ""}`}
                                id='portfolio'
                            >
                                <Portfolio />
                            </section>
