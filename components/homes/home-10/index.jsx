                        ...
                        <div className='col-sm-8 col-lg-6 col-xl-4 offset-xl-1 mt-n10'>
                            <div className='wow linesAnimIn' data-splitting='lines'>
                                <p className='lead mt-0 mb-40'>
                                    Resonance is a full-service creative studio creating beautiful digital experiences and products. We are a company
                                    specializing in design and engineering.
                                </p>
                                <p className='mb-40'>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum euismod augue ac faucibus aliquet. Fusce eu
                                    nibh enim. Etiam sit amet felis molestie tellus condimentum feugiat. Sed scelerisque dui id maximus imperdiet
                                    euismod ultrices placerat euismod ultrices placerat.
                                </p>
                            </div>
                            ...
                            <div className='local-scroll wow fadeInUp' data-wow-offset='0'>
                                {onePage ? (
                                    <>
                                        <a href='#team' className='btn btn-mod btn-white btn-large btn-round btn-hover-anim'>
                                            <span>
                                                Learn More
                    ...
                    <div className='col-lg-6 mt-n30 mt-md-0 mb-30 mb-md-0'>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className='mb-50'>
                                    Phasellus nisl lectus, tincidunt eget fermentum quis, accumsan a sem efficitur augue ac ex maximus, eget viverra
                                    sem aliquam. Donec blandit ante nunc, nec pellentesque arcu egestas a lorem.
                                </p>
                                {/* Features List */}
                ...
                <div className='container'>
                    <div className='row mb-90 mb-sm-50'>
                        <div className='col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center'>
                            ...
                            <p className='mb-0'>
                                Etiam et arcu nec quam laoreet hendrerit eget sed velit. Fusce convallis elit at ex sodales, quis maximus augue
                                hendrerit. Phasellus eget turpis vel nibh convallis vulputate. Pellentesque efficitur augue ac ex maximus, eget
                                viverra sem aliquam. Mauris egestas, lectus sed accumsan varius.
                            </p>
                        </div>
                    </div>
                    <Testimonials />
