...
export const metadata = {
    title: "Element Page Features Dark || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
                        ...
                        <main id='main'>
                            <section className='page-section pt-0 pb-0' id='home'>
                                <ParallaxContainer
                                    ...
                                    style={{
                                        backgroundImage: "url(/assets/images/full-width-images/section-bg-2.jpg)",
                                    }}
                                >
                            ...
                            <>
                                                ...
                                                <div className='services-3-item round text-center'>
                                                    <div className='wow fadeInUpShort' data-wow-offset={50}>
                                                        ...
                                                        <div className='services-3-text'>
                                                            A brand is a name, term, design, lorem ipsum symbol or any other feature that identifies
                                            ...
                                            <div className='col-md-6 col-lg-4 d-flex align-items-stretch mb-30'>
                                                <div className='services-3-item round text-center'>
                                                    <div className='wow fadeInUpShort' data-wow-offset={50}>
                                                        ...
                                                        <div className='services-3-text'>
                                                            Product design is sometimes confused with industrial design, and has recently become a
                                                            broad term inclusive of service, and physical product design.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className='col-md-6 col-lg-4 d-flex align-items-stretch mb-30'>
                                                <div className='services-3-item round text-center'>
                                                    <div className='wow fadeInUpShort' data-wow-offset={50}>
                                                        ...
                                                        <div className='services-3-text'>
                                                            In traditional animation, images are drawn or painted by hand on transparent celluloid
                                                            sheets to be photographed and exhibited on film or other media.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className='col-md-6 col-lg-4 d-flex align-items-stretch mb-30'>
                                                <div className='services-3-item round text-center'>
                                                    <div className='wow fadeInUpShort' data-wow-offset={50}>
                                                        ...
                                                        <div className='services-3-text'>
                                                            Marketing is typically done by the seller or retailer. Sometimes tasks are contracted to a
                                                            dedicated marketing firm or advertising agency and business.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className='col-lg-5 col-xl-5 offset-xl-1 d-flex align-items-center mb-md-60 mb-sm-40'>
                                                <div className='w-100'>
                                                    ...
                                                    <p className='section-descr mb-50 mb-sm-30'>
                                                        A static website stores a unique file for every page of a static website. Each time that page
                                                        is requested, the same content is returned.
                                                    </p>
                                                    {/* Numbers */}
                                                    ...
                                                    <div className='row masonry mb-n30 wow fadeInUp'>
                                                        ...
                                                        <div className='col-md-6 mb-30'>
                                                            <div className='alt-features-item box-shadow text-center mt-0'>
                                                                ...
                                                                <h4 className='alt-features-title'>Clean &amp; Minimal</h4>
                                                                <div className='alt-features-descr'>
                                                        ...
                                                        <div className='col-md-6 mb-30'>
                                                            <div className='alt-features-item box-shadow text-center mt-0'>
                                                                ...
                                                                <div className='alt-features-descr'>
                                                                    Vivamus varius, nisi vel dictum tempor, libero nisl iaculis est, ut rutrum elit
                                                                    ante ac velit.
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div className='row mt-n30'>
                                            ...
                                            >
                                                <div className='features-2-item pt-sm-40 pb-sm-40'>
                                                    ...
                                                    <div className='features-2-descr'>
                                                        Integer commodo mi ut velit bibendum eleifend. Duis nulla lectus, pharetra eu rhoncus id,
                                                        pharetra ut turpis.
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            >
                                                <div className='features-2-item pt-sm-40 pb-sm-40'>
                                                    ...
                                                    <div className='features-2-descr'>
                                                        Doneck maximus, dolor a condimentum congue, tellus nisi dictum magna, ut viverra massa ex sit
                                                        amet nulla.
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            >
                                                <div className='features-2-item pt-sm-40 pb-sm-40'>
                                                    ...
                                                    <div className='features-2-descr'>
                                                        Curabitur efficitur, nibh sed vestibulum facilisis, libero lacus accumsan erat, quis ultrices
                                                        risus urna a lectus.
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <section className='page-section bg-dark-1 light-content'>
                                    <div className='container position-relative'>
                                        ...
                                        <div className='row mt-n30'>
                                            {/* Feature Item */}
                                            <div className='col-sm-6 col-xl-3 d-flex align-items-stretch wow fadeScaleIn' data-wow-delay={0}>
                                            ...
                                            {/* End Feature Item */}
                                            {/* Feature Item */}
                                            <div className='col-sm-6 col-xl-3 d-flex align-items-stretch wow fadeScaleIn' data-wow-delay='0.1s'>
                                                <div className='alt-features-item box-shadow text-center mt-30'>
                                                    <div className='alt-features-icon mb-10'>
                                                        <svg
                                                            width={24}
                                            ...
                                            {/* End Feature Item */}
                                            {/* Feature Item */}
                                            <div className='col-sm-6 col-xl-3 d-flex align-items-stretch wow fadeScaleIn' data-wow-delay='0.2s'>
                                                <div className='alt-features-item box-shadow text-center mt-30'>
                                                    <div className='alt-features-icon mb-10'>
                                                        <svg
                                                            width={24}
                                            ...
                                            {/* End Feature Item */}
                                            {/* Feature Item */}
                                            <div className='col-sm-6 col-xl-3 d-flex align-items-stretch wow fadeScaleIn' data-wow-delay='0.3s'>
                                                <div className='alt-features-item box-shadow text-center mt-30'>
                                                    <div className='alt-features-icon mb-10'>
                                                        <svg
                                                            width={24}
                                ...
                                <section
                                    ...
                                    style={{
                                        backgroundImage: "url(/assets/images/full-width-images/section-bg-4.jpg)",
                                    }}
                                >
                                    <Features />
                                </section>
                                        ...
                                        <div className='row'>
                                            ...
                                            <div className='col-md-4 col-lg-3 d-flex align-items-stretch'>
                                                <div className='alt-features-item border-left mt-0'>
                                                    ...
                                                    <h4 className='alt-features-title'>Clean and Minimal</h4>
                                                    <div className='alt-features-descr'>
                                                        Maecenas volutpat, diam enime volutpa cramas luctus interdum sodales.
                                                    </div>
                                                </div>
