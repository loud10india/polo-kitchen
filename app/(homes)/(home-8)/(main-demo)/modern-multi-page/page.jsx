...
export const metadata = {
    title: "Home 8 Main Demo MultiPage || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
        ...
        <>
            <div className='theme-modern'>
                <div className='page' id='top'>
                    ...
                    <main id='main'>
                        <section className='home-section parallax-mousemove-scene scrollSpysection' id='home'>
                            <Hero1 />
                        </section>
