...
export const metadata = {
    title: "Home 1 Typed Text MultiPage || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
                    ...
                    <main id='main'>
                        <section className='home-section bg-gradient-gray-light-1 bg-scroll scrollSpysection' id='home'>
                            <div className='bg-shape-1 wow fadeIn'>
                                <Image width='1443' height='844' src='/assets/images/bg-shape-1.svg' alt='' className='opacity-05' />
                            </div>
                            <Hero2 />
                        </section>
                        <Home1 />
