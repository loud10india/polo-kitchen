...
export const metadata = {
    title: "Element Page Header White || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
                ...
                <div className='page' id='top'>
                    ...
                    <main id='main'>
                        <section className='page-section pt-0 pb-0' id='home'>
                            <ParallaxContainer
                                className='page-section bg-gray-light-1  parallax-5'
                                style={{
                                    backgroundImage: "url(/assets/images/full-width-images/kitchen.jpg)",
                                    ...
                                    <div className='text-center'>
                                        <div className='row'>
                                            ...
                                            <div className='col-md-8 offset-md-2'>
                                                <h1 className='hs-title-1 mb-20 text-light'>
                                                ...
                                                <div className='row'>
                                                    <div className='col-md-10 offset-md-1 col-lg-8 offset-lg-2'>
                                                        <p
                                                            className='section-descr mb-0 wow fadeIn text-light'
                                                            data-wow-delay='0.2s'
