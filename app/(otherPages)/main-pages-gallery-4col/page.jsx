                    ...
                    <main id='main'>
                        <section className='page-section pt-0 pb-0' id='home'>
                            <ParallaxContainer
                                ...
                                style={{
                                    backgroundImage: "url(/assets/images/full-width-images/page-title-bg-5.jpg)",
                                }}
                            >
                                <>
                            ...
                            <section className='page-section'>
                                <div className='container position-relative'>
                                    ...
                                    <div className='position-relative'>
                                        ...
                                        >
                                            <Image className='svg-shape' src='/assets/images/decoration-3.svg' width={148} height={148} alt='' />
                                        </div>
                                    </div>
